...
def write_summary(records, path):
    ...
    # Placeholder for the qualitative insights Claude writes from sessions.csv
    # after this deterministic report is generated (see SKILL.md). The markers
    # give Claude a stable, unique region to replace on every run.
    L("## Insights & assessment\n")
    L("<!-- INSIGHTS:START -->")
    L("_Pending: generated by Claude from `sessions.csv` after the "
      "deterministic report is written._")
    L("<!-- INSIGHTS:END -->")
    L("")
